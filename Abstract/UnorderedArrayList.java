...
/*
     UML Diagram
     -----------
     Class Name: UnorderedArrayList
     -------------------------------
     Class Variables :
     ---------------
     Class Methods :
     +UnorderedArrayList(int)
     +UnorderedArrayList()
     +UnorderedArrayList(UnorderedArrayList)
     +reqSearch(DataElement): int
