...
public class PartTimeEmployee extends Person
{
    ...
    private String salary;  //employees salary
    ...
    {
        return (super.toString() + " wages are: " + salary);
    }
    ...
    public void getDisplay(double wages)
    {
        ...
        //stores wages in salary
    public double calculatePay()
    {
		//local vaiables
		double temp; //holds overtime pay

		//if employee worked overtime, then calc overtime pay
		if(hoursWorked > OVERTIME)

			temp = ((hoursWorked - OVERTIME) * payRate
