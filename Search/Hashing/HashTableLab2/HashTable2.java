...
{// begin class
    ...
    {// begin main
        ...
        //boolean re[resentaition of whether a search
        //item has been found in the hash table
        boolean found;
        ...
        String [] words = {"MOE", "SAM", "ABE", "RAY", "JOE", "GIL", "BOB",
                           "ZAK", "KIM", "TOM", "ZOE", "LIZ"};
